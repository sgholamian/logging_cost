...
public class JavaGradientBoostingClassificationExample {
  public static void main(String[] args) {
    ...
    String datapath = "hdfs://192.168.210.11:8020/input_gradient";
    ...
    boostingStrategy.setNumIterations(200); // Note: Use more iterations in practice.
    ...
    model.save(jsc.sc(), "hdfs://192.168.210.11:8020/output_gradient/myGradientBoostingClassificationModel");
    //GradientBoostedTreesModel sameModel = GradientBoostedTreesModel.load(jsc.sc(),
    //  "target/tmp/myGradientBoostingClassificationModel");  
