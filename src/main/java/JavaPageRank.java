...
public final class JavaPageRank {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //     URL         neighbor URL
    //     ...
    //JavaRDD<String> data = jsc.textFile("hdfs://192.168.210.11:8020/input_kmean");
    JavaRDD<String> lines = spark.read().textFile("hdfs://192.168.210.11:8020/input_pagerank").javaRDD();
    ...
    ranks.coalesce(1).saveAsTextFile("hdfs://192.168.210.11:8020/output"); 
